...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color: #054;">Husain Burhanpurwala</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - ProfiloAI**")
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="#" style="text-decoration: none; color: grey;">Husain Burhanpurwala</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Husain ! Total %d " % values + " User's Have Used Our Tool : )")                
